...
namespace WindowsFormsApplication {
    ...
    public partial class PatientVisitInfoDataSet : global::System.Data.DataSet {
        ...
        public partial class patient_testsDataTable : global::System.Data.TypedTableBase<patient_testsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public patient_testsRow Addpatient_testsRow(patient_visitRow parentpatient_visitRowByFK_patient_tests_patient_visit, int testID, System.DateTime test_ordered, System.DateTime test_taken, System.DateTime test_completed, string results, string test_name) {
        ...
        public partial class patient_visit_notesDataTable : global::System.Data.TypedTableBase<patient_visit_notesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public patient_visit_notesRow Addpatient_visit_notesRow(patient_visitRow parentpatient_visitRowByFK_patient_visit_notes_patient_visit, string note, System.DateTime date, string last_name) {
                ...
                if ((parentpatient_visitRowByFK_patient_visit_notes_patient_visit != null)) {
                    columnValuesArray[1] = parentpatient_visitRowByFK_patient_visit_notes_patient_visit[0];
                }
        ...
        public partial class patient_visit_symptomsDataTable : global::System.Data.TypedTableBase<patient_visit_symptomsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public patient_visit_symptomsRow Addpatient_visit_symptomsRow(patient_visitRow parentpatient_visitRowByFK_patient_visit_symptoms_patient_visit, string symptom_name, int diagnoses_diagnosesID, string diagnoses_name, string diagnoses_description, string diagnoses_treatment) {
        ...
        public partial class patient_testsRow : global::System.Data.DataRow {
            ...
            public string test_name {
                get {
                    return ((string)(this[this.tablepatient_tests.test_nameColumn]));
                }
                set {
                    this[this.tablepatient_tests.test_nameColumn] = value;
                }
            }
        ...
        public partial class patient_visit_notesRow : global::System.Data.DataRow {
            ...
            public string last_name {
                get {
                    return ((string)(this[this.tablepatient_visit_notes.last_nameColumn]));
                }
                set {
                    this[this.tablepatient_visit_notes.last_nameColumn] = value;
                }
            }
        ...
        public partial class patient_visit_symptomsRow : global::System.Data.DataRow {
            ...
            public string diagnoses_name {
                get {
                    return ((string)(this[this.tablepatient_visit_symptoms.diagnoses_nameColumn]));
                }
                set {
                    this[this.tablepatient_visit_symptoms.diagnoses_nameColumn] = value;
                }
            }
            ...
            public string diagnoses_description {
                get {
                    return ((string)(this[this.tablepatient_visit_symptoms.diagnoses_descriptionColumn]));
                }
                set {
                    this[this.tablepatient_visit_symptoms.diagnoses_descriptionColumn] = value;
                }
            }
            ...
            public string diagnoses_treatment {
                get {
                    return ((string)(this[this.tablepatient_visit_symptoms.diagnoses_treatmentColumn]));
                }
                set {
                    this[this.tablepatient_visit_symptoms.diagnoses_treatmentColumn] = value;
                }
            }
...
namespace WindowsFormsApplication.PatientVisitInfoDataSetTableAdapters {
    ...
    public partial class patient_testsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT p.patient_testID, p.visitID, p.testID, p.test_ordered, p.test_taken, p.tes" +
                "t_completed, p.results, t.test_name \r\nFROM dbo.patient_tests p\r\n   JOIN tests t " +
        ...
        public virtual int Fill(PatientVisitInfoDataSet.patient_testsDataTable dataTable, int visitID) {
        ...
        public virtual PatientVisitInfoDataSet.patient_testsDataTable GetData(int visitID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(visitID));
...
WHERE v.visitID = @visitID";
    ...
    public partial class patient_visit_notesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT n.notesID, n.visitID, n.note, n.date, e.last_name \r\nFROM dbo.patient_visit" +
                "_notes n\r\n    JOIN employees e ON e.employeeID = n.employeeID\r\nWHERE visitID = @" +
                "visitID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@visitID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "visitID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(PatientVisitInfoDataSet.patient_visit_notesDataTable dataTable, int visitID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(visitID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual PatientVisitInfoDataSet.patient_visit_notesDataTable GetData(int visitID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(visitID));
    ...
    public partial class patient_visit_symptomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT s.symptomID, s.visitID, s.symptom_name, s.diagnoses_diagnosesID, d.diagnoses_name, d.diagnoses_description, d.diagnoses_treatment 
FROM dbo.patient_visit_symptoms s
...
WHERE s.visitID = @visitID";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(PatientVisitInfoDataSet.patient_visit_symptomsDataTable dataTable, int visitID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(visitID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual PatientVisitInfoDataSet.patient_visit_symptomsDataTable GetData(int visitID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(visitID));
