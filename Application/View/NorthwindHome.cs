...
namespace WindowsFormsApplication.View
{
    public partial class NorthwindAdmin : Form
    {
        ...
        private void listTestsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NWViewTests NWViewTestsForm = NWViewTests.GetChildInstance();
            NWViewTestsForm.MdiParent = this;
        ...
        {
            NWViewAllergies NWViewAllergiesForm = NWViewAllergies.GetChildInstance();
            NWViewAllergiesForm.MdiParent = this;
            NWViewAllergiesForm.Show();
            NWViewAllergiesForm.BringToFront();
        }
    }
}
