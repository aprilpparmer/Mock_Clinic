...
namespace WindowsFormsApplication {
    ...
    public partial class _CS6232_g7DataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/_CS6232_g7DataSet1.xsd";
        ...
        public partial class positionsDataTable : global::System.Data.TypedTableBase<positionsRow> {
            ...
            private void InitClass() {
                ...
                this.columnposition_name.MaxLength = 25;
            }
    ...
    public partial class positionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[positions] WHERE (([positionID] = @Original_positionID) AND ((" +
                "@IsNull_position_name = 1 AND [position_name] IS NULL) OR ([position_name] = @Or" +
                "iginal_position_name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[positions] ([position_name]) VALUES (@position_name);\r\nSELECT " +
                "positionID, position_name FROM positions WHERE (positionID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[positions] SET [position_name] = @position_name WHERE (([positionID] = @Original_positionID) AND ((@IsNull_position_name = 1 AND [position_name] IS NULL) OR ([position_name] = @Original_position_name)));
SELECT positionID, position_name FROM positions WHERE (positionID = @positionID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT positionID, position_name FROM dbo.positions";
        ...
        public virtual int Fill(_CS6232_g7DataSet.positionsDataTable dataTable) {
        ...
        public virtual _CS6232_g7DataSet.positionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            _CS6232_g7DataSet.positionsDataTable dataTable = new _CS6232_g7DataSet.positionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(_CS6232_g7DataSet.positionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_positionID, string Original_position_name) {
        ...
        public virtual int Update(string position_name, int Original_positionID, string Original_position_name, int positionID) {
            if ((position_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string position_name, int Original_positionID, string Original_position_name) {
            return this.Update(position_name, Original_positionID, Original_position_name, Original_positionID);
        }
    }
