...
namespace WindowsFormsApplication {
    ...
    public partial class _CS6232_g7DataSet : global::System.Data.DataSet {
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public employeesRow AddemployeesRow(string last_name, string first_name, int positionID) {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employees] WHERE (([employeeID] = @Original_employeeID) AND ([" +
                "last_name] = @Original_last_name) AND ([first_name] = @Original_first_name) AND " +
                "([positionID] = @Original_positionID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [last_name] = @last_name, [first_name] = @first_name, [positionID] = @positionID WHERE (([employeeID] = @Original_employeeID) AND ([last_name] = @Original_last_name) AND ([first_name] = @Original_first_name) AND ([positionID] = @Original_positionID));
SELECT employeeID, last_name, first_name, positionID FROM employees WHERE (employeeID = @employeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employeeID, last_name, first_name, positionID FROM dbo.employees";
        ...
        public virtual int Fill(_CS6232_g7DataSet.employeesDataTable dataTable) {
        ...
        public virtual _CS6232_g7DataSet.employeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            _CS6232_g7DataSet.employeesDataTable dataTable = new _CS6232_g7DataSet.employeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(_CS6232_g7DataSet.employeesDataTable dataTable) {
